# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-06 06:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=1000, verbose_name='Chocolate Name')),
                ('description', models.CharField(blank=True, max_length=1000, verbose_name='Chocolate Description')),
                ('manufacturer', models.CharField(blank=True, max_length=1000, verbose_name='Chocolate Manufacturer')),
